        ...
        if (!DbContext.Articles.Any() && !DbContext.ArticleTags.Any() && !DbContext.Tags.Any()!)
        {
            ...
            Article[] articles = new Article[]
            {
                new()
                {
                    ...
                    UserId = user1!.Id,
                    Img_Url =
                        "https://fanspace.gg/wp-content/uploads/2022/12/5-games-1-1024x576.jpg"
                },
                new()
                {
                    ...
                    UserId = user1!.Id,
                    Img_Url =
                        "https://assetsio.reedpopcdn.com/elden-ring-bosses-in-order-main-mandatory-8042-1647011924713.jpg?width=1600&height=900&fit=crop&quality=100&format=png&enable=upscale&auto=webp"
                },
                new()
                {
