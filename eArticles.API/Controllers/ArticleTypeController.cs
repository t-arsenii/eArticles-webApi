...
public class ArticleTypeController : ControllerBase
{
    ...
    [HttpPut]
    [Authorize(Roles = "Admin")]
    public async Task<IActionResult> Update(UpdateArticleTypeDto updateArticleTypeDto)
    {
        ArticleType articleType = new() { Id = updateArticleTypeDto.Id, Title = updateArticleTypeDto.Title };
